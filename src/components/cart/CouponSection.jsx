      ...
      {offers.length > 0 && (
        <>
          <button
            ...
            className="flex w-full items-center justify-between border-t border-slate-100 px-6 py-4 transition hover:bg-slate-50"
          >
              ...
              {offers.map((offer) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="rounded-lg bg-green-50 px-3 py-2 text-sm font-semibold text-green-600 transition hover:bg-green-100"
                  >
                    Apply
                  </button>
                </div>
