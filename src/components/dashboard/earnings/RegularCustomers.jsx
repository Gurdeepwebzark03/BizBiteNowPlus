        ...
        {filteredCustomers.length === 0 ? (
          ...
          filteredCustomers.map((customer) => {
            ...
            return (
              ...
              <div
                key={customer.id}
                className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
              >
