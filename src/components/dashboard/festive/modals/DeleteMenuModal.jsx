  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex justify-end gap-3 border-t px-6 py-5 dark:border-slate-700">
          <button
            onClick={onClose}
            className="rounded-xl border px-5 py-2.5 transition hover:bg-slate-100 dark:hover:bg-slate-800"
          >
            Cancel
          </button>
