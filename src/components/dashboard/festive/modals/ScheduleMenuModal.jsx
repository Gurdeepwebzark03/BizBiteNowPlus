  ...
  return (
    ...
    >
      <div
        ...
        className="w-full max-w-2xl rounded-2xl bg-white dark:bg-slate-900 shadow-2xl overflow-hidden"
      >
        {/* Header */}
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b dark:border-slate-700">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="rounded-xl bg-blue-100 dark:bg-blue-500/10 p-3">
              <CalendarDays
                size={22}
