    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4 py-12">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-2xl space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-gray-500">Create your business account to get started.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Security PIN */}
            <div>
              <label className="text-sm font-semibold text-gray-700 block mb-1">Security PIN (Password)</label>
              <div className="relative">
